    ...
    private boolean AutenticarUsuario() {
        ...
        try{
            ...
            if(adminBL.getCreateDB(getApplicationContext())) {
                ...
                usuario = usuarioBL.getVerificaUsuario(getApplicationContext(), mUsuarioView.getText().toString(), mPasswordView.getText().toString());

            }
            else {
                msg = "Error al Crear la Base de Datos...";
                flag = false;
            }
